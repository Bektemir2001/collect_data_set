            ...
            <div class="row align-items-center justify-content-center h-100">
                <div class="col-md-5">
                    <div class="card p-3">
                        <div class="card-body">
                            <div class="auth-logo">
                                <img src="{{asset('assets/images/dyce-logo.png')}}" class="img-fluid  rounded-normal  darkmode-logo" alt="logo">
                                <img src="{{asset('assets/images/dyce-logo.png')}}" class="img-fluid rounded-normal light-logo" alt="logo">
                            </div>
                            ...
                            <form action="{{route('admin.register')}}" method="POST">
                                ...
                                <div class="col-lg-12 mt-3">
                                    <p class="mb-0 text-center">Don't have an account? <a href="{{route('admin.login')}}">Log In</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
