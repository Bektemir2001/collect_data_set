            ...
            <div class="row align-items-center justify-content-center h-100">
                <div class="col-md-5">
                    <div class="card p-3">
                        <div class="card-body">
                            <div class="auth-logo">
                                <img src="{{asset('admin_files/assets/images/img.png')}}" class="img-fluid  rounded-normal  darkmode-logo" alt="logo">
                            ...
                            <form action="{{route('admin.login')}}" method="POST">
                                ...
                                <div class="col-lg-12 mt-3">
                                    <p class="mb-0 text-center">Don't have an account? <a href="{{route('admin.register')}}">Sign Up</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
