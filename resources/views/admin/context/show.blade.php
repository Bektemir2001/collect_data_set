    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{route('context.update', $context->id)}}" method="POST">
                ...
                <div id="textToCopy" style="display: none">{{"Generate questions and detailed answers based on the following text in Kyrgyz language return 'Question:' 'Answer:'"}} <div>{{$context->title != null ? $context->title : ""}}</div> {!!$context->context !!}</div>
