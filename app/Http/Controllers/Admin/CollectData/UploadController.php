    ...
    public function CSV(Request $request)
    {
        if ($request->hasFile('csv_file')) {
            ...
            if ($selectedSeparator) {
                ...
                if(in_array('context', $headers) && in_array('title', $headers))
                {
                ...
                return redirect()->route('context.index')->with(['notification' => 'CSV файл должен содержать поля "title" и "context".']);
            } else {
